"""
Lote 15 — 100 leads: 50 para cada SDR (Karolaine e Miguel)
...
O que faz:
  ...
  - Salva lote15.xlsx para passar ao import_from_planilha.py
"""
...
OUTPUT_LOTE = os.path.join(SCRIPT_DIR, "Planilha_Importacao_CRM_Novos_SDR_lote15.xlsx")
...
def main():
    print("=" * 60)
    print("LOTE 15 — 100 cards (50 por SDR × 2 SDRs: Karolaine e Miguel)")
    print("=" * 60)
    ...
    print(f"\nlote15.xlsx salvo com {len(rows_to_process)} linhas (dados a partir da row 5 — sem card faltante).")
    print("\nPróximo passo:")
    print("  python scripts/imports/import_from_planilha.py C:/Users/HS/Documents/GitHub/hsgrowth-sistema/backend/scripts/imports/Planilha_Importacao_CRM_Novos_SDR_lote15.xlsx")
    print("=" * 60)
