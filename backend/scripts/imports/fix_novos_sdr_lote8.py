"""
Lote 8 — 150 leads: 50 para cada SDR (apenas SDRs ativos)
  - Claudia                              (id=8)
...
O que faz:
  ...
  - Salva lote8.xlsx para passar ao import_from_planilha.py
"""
...
OUTPUT_LOTE = os.path.join(SCRIPT_DIR, "Planilha_Importacao_CRM_Novos_SDR_lote8.xlsx")
...
def main():
    print("=" * 60)
    print("LOTE 8 — 150 cards (50 por SDR × 3 SDRs ativos)")
    print("=" * 60)
    ...
    print(f"\nlote8.xlsx salvo com {len(rows_to_process)} linhas (dados a partir da row 5 — sem card faltante).")
    print("\nPróximo passo:")
    print("  python scripts/imports/import_from_planilha.py d:/GitHub/hsgrowth-sistema/backend/scripts/imports/Planilha_Importacao_CRM_Novos_SDR_lote8.xlsx")
    print("=" * 60)
