"""
Transportadoras — Lote 1 — 300 leads: 100 para cada SDR (Claudia, Karolaine e Miguel)
  - Claudia                              (id=8)
...
O que faz:
  ...
  - Pega as próximas 300 linhas sem Status_Importacao
  - Distribui 100 linhas por SDR na ordem acima
  - Preenche Canal_Aquisicao = "Outbound" / Detalhe = "Outbound - Lista fria"
  - Marca como "Importado" na coluna Status_Importacao
  - Salva transportadoras_lote1.xlsx para passar ao import_from_planilha.py
"""
...
OUTPUT_LOTE = os.path.join(SCRIPT_DIR, "Planilha_Transportadoras_Prospeccao_lote1.xlsx")
...
def main():
    print("=" * 60)
    print("TRANSPORTADORAS LOTE 1 — 300 cards (100 por SDR × 3: Claudia, Karolaine, Miguel)")
    print("=" * 60)
    ...
    print(f"\ntransportadoras_lote1.xlsx salvo com {len(rows_to_process)} linhas (dados a partir da row 5 — sem card faltante).")
    print("\nPróximo passo:")
    print("  python scripts/imports/import_from_planilha.py C:/Users/HS/Documents/GitHub/hsgrowth-sistema/backend/scripts/imports/Planilha_Transportadoras_Prospeccao_lote1.xlsx")
    print("=" * 60)
