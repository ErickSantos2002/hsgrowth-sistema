"""
Transportadoras — Lote 8 — 200 leads: 100 para cada SDR (Claudia e Karolaine)
  - Claudia                              (id=8)
...
O que faz:
  ...
  - Salva transportadoras_lote8.xlsx para passar ao import_from_planilha.py
"""
...
OUTPUT_LOTE = os.path.join(SCRIPT_DIR, "Planilha_Transportadoras_Prospeccao_lote8.xlsx")
...
def main():
    print("=" * 60)
    print("TRANSPORTADORAS LOTE 8 — 200 cards (100 Claudia + 100 Karolaine)")
    print("=" * 60)
    ...
    print(f"\ntransportadoras_lote8.xlsx salvo com {len(rows_to_process)} linhas (dados a partir da row 5 — sem card faltante).")
    print("\nPróximo passo:")
    print("  python scripts/imports/import_from_planilha.py C:/Users/HS/Documents/GitHub/hsgrowth-sistema/backend/scripts/imports/Planilha_Transportadoras_Prospeccao_lote8.xlsx")
    print("=" * 60)
