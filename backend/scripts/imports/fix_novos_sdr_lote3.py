...
O que faz:
  ...
  - Salva lote3.xlsx para passar ao import_from_planilha.py
"""
...
OUTPUT_LOTE = os.path.join(SCRIPT_DIR, "Planilha_Importacao_CRM_Novos_SDR_lote3.xlsx")
...
def main():
    print("=" * 60)
    print("LOTE 3 — 300 cards (50 por SDR × 6 SDRs)")
    print("=" * 60)
    ...
    print(f"\nlote3.xlsx salvo com {len(rows_to_process)} linhas.")
    print("\nPróximo passo:")
    print("  python scripts/imports/import_from_planilha.py d:/GitHub/hsgrowth-sistema/backend/scripts/imports/Planilha_Importacao_CRM_Novos_SDR_lote3.xlsx")
    print("=" * 60)
