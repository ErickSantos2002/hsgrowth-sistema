"""
Transportadoras — Lote 12 — 100 leads: todos para Miguel
...
O que faz:
  ...
  - Salva transportadoras_lote12.xlsx para passar ao import_from_planilha.py
"""
...
OUTPUT_LOTE = os.path.join(SCRIPT_DIR, "Planilha_Transportadoras_Prospeccao_lote12.xlsx")
...
def main():
    print("=" * 60)
    print("TRANSPORTADORAS LOTE 12 — 100 cards (todos para Miguel, id=16)")
    print("=" * 60)
    ...
    print(f"\ntransportadoras_lote12.xlsx salvo com {len(rows_to_process)} linhas (dados a partir da row 5 — sem card faltante).")
    print("\nPróximo passo:")
    print("  python scripts/imports/import_from_planilha.py C:/Users/HS/Documents/GitHub/hsgrowth-sistema/backend/scripts/imports/Planilha_Transportadoras_Prospeccao_lote12.xlsx")
    print("=" * 60)
