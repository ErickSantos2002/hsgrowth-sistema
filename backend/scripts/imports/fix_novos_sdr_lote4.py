"""
Lote 4 — 300 leads: 50 para cada SDR
...
O que faz:
  ...
  - Salva lote4.xlsx para passar ao import_from_planilha.py
"""
...
OUTPUT_LOTE = os.path.join(SCRIPT_DIR, "Planilha_Importacao_CRM_Novos_SDR_lote4.xlsx")
...
# Ordem de distribuição: 50 cards cada
SDRS = [
    "Ãhwaryoné",
    "Miguel",
    "Lucas",
...
def main():
    print("=" * 60)
    print("LOTE 4 — 300 cards (50 por SDR × 6 SDRs)")
    print("=" * 60)
    ...
    # então os dados começam na row 5 para que todos os 300 cards sejam importados sem perda.
    ...
    print(f"\nlote4.xlsx salvo com {len(rows_to_process)} linhas (dados a partir da row 5 — sem card faltante).")
    print("\nPróximo passo:")
    print("  python scripts/imports/import_from_planilha.py d:/GitHub/hsgrowth-sistema/backend/scripts/imports/Planilha_Importacao_CRM_Novos_SDR_lote4.xlsx")
    print("=" * 60)
