"""
Lote 13 — 50 leads: todos para Miguel
...
OUTPUT_LOTE = os.path.join(SCRIPT_DIR, "Planilha_Importacao_CRM_Novos_SDR_lote13.xlsx")
...
def main():
    print("=" * 60)
    print("LOTE 13 — 50 cards (todos para Miguel, id=16)")
    print("=" * 60)
    ...
    print(f"\nlote13.xlsx salvo com {len(rows_to_process)} linhas (dados a partir da row 5 — sem card faltante).")
    print("\nPróximo passo:")
    print("  python scripts/imports/import_from_planilha.py C:/Users/HS/Documents/GitHub/hsgrowth-sistema/backend/scripts/imports/Planilha_Importacao_CRM_Novos_SDR_lote13.xlsx")
    print("=" * 60)
