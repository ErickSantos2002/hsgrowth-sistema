"""
Lote 5 — 180 leads: 30 para cada SDR
  - Ãhwaryoné Barbosa Bandeira De Melo (id=14)
...
O que faz:
  ...
  - Pega as próximas 180 linhas sem Status_Importacao
  - Distribui 30 linhas por SDR na ordem acima
  - Preenche Canal_Aquisicao = "Outbound" / Detalhe = "Outbound - Lista fria"
  - Marca como "Importado" na coluna Status_Importacao
  - Salva lote5.xlsx para passar ao import_from_planilha.py
"""
...
OUTPUT_LOTE = os.path.join(SCRIPT_DIR, "Planilha_Importacao_CRM_Novos_SDR_lote5.xlsx")
...
# Ordem de distribuição: 30 cards cada
SDRS = [
    "Ãhwaryoné",
    "Miguel",
    "Lucas",
...
def main():
    print("=" * 60)
    print("LOTE 5 — 180 cards (30 por SDR × 6 SDRs)")
    print("=" * 60)
    ...
    # então os dados começam na row 5 para que todos os 180 cards sejam importados sem perda.
    ...
    print(f"\nlote5.xlsx salvo com {len(rows_to_process)} linhas (dados a partir da row 5 — sem card faltante).")
    print("\nPróximo passo:")
    print("  python scripts/imports/import_from_planilha.py d:/GitHub/hsgrowth-sistema/backend/scripts/imports/Planilha_Importacao_CRM_Novos_SDR_lote5.xlsx")
    print("=" * 60)
