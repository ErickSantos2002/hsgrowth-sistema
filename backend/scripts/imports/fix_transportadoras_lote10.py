"""
Transportadoras — Lote 10 — 100 leads: todos para Claudia
  - Claudia                              (id=8)
...
OUTPUT_LOTE = os.path.join(SCRIPT_DIR, "Planilha_Transportadoras_Prospeccao_lote10.xlsx")
...
def main():
    print("=" * 60)
    print("TRANSPORTADORAS LOTE 10 — 100 cards (todos para Claudia, id=8)")
    print("=" * 60)
    ...
    print(f"\ntransportadoras_lote10.xlsx salvo com {len(rows_to_process)} linhas (dados a partir da row 5 — sem card faltante).")
    print("\nPróximo passo:")
    print("  python scripts/imports/import_from_planilha.py C:/Users/HS/Documents/GitHub/hsgrowth-sistema/backend/scripts/imports/Planilha_Transportadoras_Prospeccao_lote10.xlsx")
    print("=" * 60)
