"""
Transportadoras — Lote 6 — 100 leads: 50 para cada SDR (Claudia e Miguel)
  - Claudia                              (id=8)
...
O que faz:
  ...
  - Salva transportadoras_lote6.xlsx para passar ao import_from_planilha.py
"""
...
OUTPUT_LOTE = os.path.join(SCRIPT_DIR, "Planilha_Transportadoras_Prospeccao_lote6.xlsx")
...
def main():
    print("=" * 60)
    print("TRANSPORTADORAS LOTE 6 — 100 cards (50 Claudia + 50 Miguel)")
    print("=" * 60)
    ...
    print(f"\ntransportadoras_lote6.xlsx salvo com {len(rows_to_process)} linhas (dados a partir da row 5 — sem card faltante).")
    print("\nPróximo passo:")
    print("  python scripts/imports/import_from_planilha.py C:/Users/HS/Documents/GitHub/hsgrowth-sistema/backend/scripts/imports/Planilha_Transportadoras_Prospeccao_lote6.xlsx")
    print("=" * 60)
