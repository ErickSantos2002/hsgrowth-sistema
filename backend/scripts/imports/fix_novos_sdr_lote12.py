...
O que faz:
  ...
  - Salva lote12.xlsx para passar ao import_from_planilha.py
"""
...
OUTPUT_LOTE = os.path.join(SCRIPT_DIR, "Planilha_Importacao_CRM_Novos_SDR_lote12.xlsx")
...
def main():
    print("=" * 60)
    print("LOTE 12 — 60 cards (30 por SDR × 2 SDRs: Karolaine e Miguel)")
    print("=" * 60)
    ...
    print(f"\nlote12.xlsx salvo com {len(rows_to_process)} linhas (dados a partir da row 5 — sem card faltante).")
    print("\nPróximo passo:")
    print("  python scripts/imports/import_from_planilha.py C:/Users/HS/Documents/GitHub/hsgrowth-sistema/backend/scripts/imports/Planilha_Importacao_CRM_Novos_SDR_lote12.xlsx")
    print("=" * 60)
