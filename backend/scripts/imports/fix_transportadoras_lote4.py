"""
Transportadoras — Lote 4 — 100 leads: 50 para cada SDR (Karolaine e Claudia)
  - Karolaine Martins                    (id=9)
  - Claudia                              (id=8)

Fonte: Planilha_Transportadoras_Prospeccao_fixed.xlsx (padronizada de Planilha_Nova_030726).

As linhas pendentes já estão ordenadas com Website primeiro, então este lote
pega automaticamente empresas com site.
...
O que faz:
  ...
  - Salva transportadoras_lote4.xlsx para passar ao import_from_planilha.py
"""
...
OUTPUT_LOTE = os.path.join(SCRIPT_DIR, "Planilha_Transportadoras_Prospeccao_lote4.xlsx")
...
def main():
    print("=" * 60)
    print("TRANSPORTADORAS LOTE 4 — 100 cards (50 Karolaine + 50 Claudia)")
    print("=" * 60)
    ...
    print(f"\ntransportadoras_lote4.xlsx salvo com {len(rows_to_process)} linhas (dados a partir da row 5 — sem card faltante).")
    print("\nPróximo passo:")
    print("  python scripts/imports/import_from_planilha.py C:/Users/HS/Documents/GitHub/hsgrowth-sistema/backend/scripts/imports/Planilha_Transportadoras_Prospeccao_lote4.xlsx")
    print("=" * 60)
