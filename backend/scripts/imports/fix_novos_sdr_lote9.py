"""
Lote 9 — 100 leads: 50 para cada SDR (Karolaine e Miguel; Claudia excluída neste lote)
...
O que faz:
  ...
  - Salva lote9.xlsx para passar ao import_from_planilha.py
"""
...
OUTPUT_LOTE = os.path.join(SCRIPT_DIR, "Planilha_Importacao_CRM_Novos_SDR_lote9.xlsx")
...
# Claudia excluída neste lote (Aury e Lucas desligados em 12/05/2026)
SDRS = [
    "Karolaine",
    "Miguel",
]
...
def main():
    print("=" * 60)
    print("LOTE 9 — 100 cards (50 por SDR × 2 SDRs: Karolaine e Miguel)")
    print("=" * 60)
    ...
    print(f"\nlote9.xlsx salvo com {len(rows_to_process)} linhas (dados a partir da row 5 — sem card faltante).")
    print("\nPróximo passo:")
    print("  python scripts/imports/import_from_planilha.py d:/GitHub/hsgrowth-sistema/backend/scripts/imports/Planilha_Importacao_CRM_Novos_SDR_lote9.xlsx")
    print("=" * 60)
