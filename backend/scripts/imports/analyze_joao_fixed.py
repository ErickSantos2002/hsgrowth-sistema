"""Valida o arquivo corrigido do João Victor."""
import openpyxl, sys, io
from datetime import datetime, date

sys.stdout = io.TextIOWrapper(sys.stdout.buffer, encoding='utf-8', errors='replace')

wb = openpyxl.load_workbook('Planilha_Importacao_CRM_JOAO_VICTOR_fixed.xlsx')
ws = wb.worksheets[0]
...
for r in range(5, ws.max_row + 1):
    ...
    for col, nome in [(1, 'Data_Criacao'), (37, 'Data_Prospecao'), (39, 'Ativ1_Data'),
        ...
        if v is not None and not isinstance(v, (datetime, date)):
            row_issues.append(f'[FORMATO] {nome}: texto puro')
...
sep = '=' * 60
print(sep)
print('VALIDACAO - PLANILHA JOAO VICTOR (FIXED)')
print(sep)
...
if issues:
    ...
    print('Nenhum problema! Planilha pronta para importacao.')
print(sep)
