"""
Transportadoras — Lote 3 — 100 leads: todos para Miguel
...
Primeiro lote com os campos novos (Site / Linkedin_Empresa / Notes_Cliente) e com a
priorização por Website — as linhas pendentes já estão ordenadas com site primeiro.

O que faz:
  - Lê Planilha_Transportadoras_Prospeccao_fixed.xlsx
  - Pega as próximas 100 linhas sem Status_Importacao (as com site vêm primeiro)
  - Atribui as 100 linhas a Miguel
  - Preenche Canal_Aquisicao = "Outbound" / Detalhe = "Outbound - Lista fria"
  - Marca como "Importado" na coluna Status_Importacao
  - Salva transportadoras_lote3.xlsx para passar ao import_from_planilha.py
"""
...
OUTPUT_LOTE = os.path.join(SCRIPT_DIR, "Planilha_Transportadoras_Prospeccao_lote3.xlsx")
...
def main():
    print("=" * 60)
    print("TRANSPORTADORAS LOTE 3 — 100 cards (todos para Miguel, id=16)")
    print("=" * 60)
    ...
    # Coleta próximas linhas livres (já ordenadas com site primeiro no _fixed)
    pending = []
    ...
    # Sanity check: quantos deste lote têm site?
    ...
    print(f"\ntransportadoras_lote3.xlsx salvo com {len(rows_to_process)} linhas (dados a partir da row 5 — sem card faltante).")
    print("\nPróximo passo:")
    print("  python scripts/imports/import_from_planilha.py C:/Users/HS/Documents/GitHub/hsgrowth-sistema/backend/scripts/imports/Planilha_Transportadoras_Prospeccao_lote3.xlsx")
    print("=" * 60)
