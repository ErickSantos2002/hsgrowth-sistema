"""
Lote 6 — 150 leads: 30 para cada SDR (sem Sérgio)
...
O que faz:
  ...
  - Salva lote6.xlsx para passar ao import_from_planilha.py
"""
...
OUTPUT_LOTE = os.path.join(SCRIPT_DIR, "Planilha_Importacao_CRM_Novos_SDR_lote6.xlsx")
...
# Ordem de distribuição: 30 cards cada (sem Sérgio)
SDRS = [
    "Ãhwaryoné",
    "Miguel",
    "Lucas",
...
def main():
    print("=" * 60)
    print("LOTE 6 — 150 cards (30 por SDR × 5 SDRs, sem Sérgio)")
    print("=" * 60)
    ...
    print(f"\nlote6.xlsx salvo com {len(rows_to_process)} linhas (dados a partir da row 5 — sem card faltante).")
    print("\nPróximo passo:")
    print("  python scripts/imports/import_from_planilha.py d:/GitHub/hsgrowth-sistema/backend/scripts/imports/Planilha_Importacao_CRM_Novos_SDR_lote6.xlsx")
    print("=" * 60)
