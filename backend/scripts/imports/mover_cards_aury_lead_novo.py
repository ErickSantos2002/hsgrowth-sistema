"""
Move todos os cards do Aury (id=14) da lista Prospecção (id=23)
para a lista Lead Novo (id=22) no board Prospecção (board_id=6).

Uso:
  python scripts/imports/mover_cards_aury_lead_novo.py          # executa
  python scripts/imports/mover_cards_aury_lead_novo.py --dry    # dry run
"""
import sys
import os
...
def main(dry_run: bool = False):
    ...
    total = len(cards)
    print(f"Cards do Aury em Prospecção (id={LIST_ORIGEM}): {total}")
