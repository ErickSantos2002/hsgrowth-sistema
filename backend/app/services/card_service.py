            ...
            payload = {
                ...
                "card": {
                    ...
                    "person": {
                        ...
                        "position": card.person.position,
                        "email_principal": card.person.email,
                        "email_comercial": card.person.email_commercial,
                        "email_pessoal": card.person.email_personal,
                        "phone": card.person.phone,
                        "phone_whatsapp": card.person.phone_whatsapp,
                    } if card.person else None,
